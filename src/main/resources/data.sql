...
INSERT INTO `member` (`mem_no`, `mem_email`, `mem_name`, `mem_pwd`, `phone`, `address1`, `address2`, `post_no`, `ad_check`, `enroll_date`, `mem_state`) VALUES (1, 'admin01@nieve.com', '관리자', '$2a$10$h5jhNcoD.dvixLPlhhPOGuOnWQI/gbcOeVPtYx7B1lAlrlMEnrFLC', '010-1234-5678', '서울시', '구로구', '01478', 'Y', '2022-11-17', 'Y');
